                 ...
                 SuperView:(UIView*)_superView
{
    ...
    UILabel *cancelLabel = [[UILabel alloc] initWithFrame:CGRectMake(40, 144, 81, 31)];
    ...
    if (cancelName != nil) 
    {
        ...
        cancelBtn.frame = CGRectMake(40, 145, 81, 31);
    ...
    if (otherButton != nil) {
        ...
        [otherBtn setFrame:CGRectMake(140, 145, 81, 31)];
        ...
        UILabel *otherLabel = [[UILabel alloc] initWithFrame:CGRectMake(140, 144, 81, 31)];
...
-(void)buttonClick:(id)sender
{
    ...
    if (delegate) 
    {
        ...
        [delegate voteViewButtonDidClick:self atIndex:index];
    }
}
