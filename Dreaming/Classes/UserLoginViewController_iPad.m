//
//  UserLoginViewController_iPad.m
//  Dreaming
//
...
@interface UserLoginViewController_iPad () {
...
@implementation UserLoginViewController_iPad
...
- (IBAction)registerUser:(id)sender {
    ...
    UserRegisterViewController_iPad *viewController = [[UserRegisterViewController_iPad alloc] init];
...
- (void)viewDidLoad {
    ...
    self.view = [[[NSBundle mainBundle] loadNibNamed:@"UserLoginView_iPad" owner:self options:nil] lastObject];
